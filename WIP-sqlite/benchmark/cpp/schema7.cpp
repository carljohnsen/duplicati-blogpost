...
const std::string CREATE_BLOCK_TABLE = "CREATE TABLE Block (ID INTEGER PRIMARY KEY, Hash VARCHAR(44) NOT NULL, Size INTEGER NOT NULL);";
...
int select_index_normal(Config &config)
{
    ...
    measure_insert(db, config, rng, "schema7_insert_index_normal");
    ...
    report_stats(config, times, "schema7_select_index_normal");
...
int select_index_hash(Config &config)
{
    ...
    measure_insert(db, config, rng, "schema7_insert_index_hash");
    ...
    report_stats(config, times, "schema7_select_index_hash");
...
int select_index_size(Config &config)
{
    ...
    measure_insert(db, config, rng, "schema7_insert_index_size");
    ...
    report_stats(config, times, "schema7_select_index_size");
